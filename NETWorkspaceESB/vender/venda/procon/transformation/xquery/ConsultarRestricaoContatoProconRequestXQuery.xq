(:: pragma bea:global-element-parameter parameter="$parametrosConsultarTelefoneLeiNaoPerturbe1" element="ns2:parametrosConsultarTelefoneLeiNaoPerturbe" location="../../wsdl/proxyservice/ProconWSDLV1_0.wsdl" ::)
...
(:: pragma bea:global-element-return element="ns3:consultarRestricaoContatoProcon" location="../../wsdl/business/RestricaoContatoProconDSLBSV1_0.wsdl" ::)

declare namespace ns4 = "http://www.netservicos.com.br/modelocanonico/v2/empresa";
declare namespace xf = "http://tempuri.org/vender/venda/procon/transformation/xquery/ConsultarRestricaoContatoProconRequestXQuery/";
...
declare function xf:ConsultarRestricaoContatoProconRequestXQuery($parametrosConsultarTelefoneLeiNaoPerturbe1 as element(ns2:parametrosConsultarTelefoneLeiNaoPerturbe),
    $identificarOperadoraNETResponse1 as element(ns0:identificarOperadoraNETResponse))
    as element(ns3:consultarRestricaoContatoProcon) {
        <ns3:consultarRestricaoContatoProcon>
            {
...
xf:ConsultarRestricaoContatoProconRequestXQuery($parametrosConsultarTelefoneLeiNaoPerturbe1,
