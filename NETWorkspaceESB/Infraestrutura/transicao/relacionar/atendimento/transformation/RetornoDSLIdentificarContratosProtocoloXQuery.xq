(:: pragma bea:global-element-parameter parameter="$identificarContratoPorProtocoloResponse1" element="ns2:identificarContratoPorProtocoloResponse" location="../wsdl/business/IdentificarContratosDSL.wsdl" ::)
(:: pragma bea:global-element-return element="ns1:consultarContratosPorProtocoloResponse" location="../wsdl/proxy/IdentificarContratos.wsdl" ::)

declare namespace xf = "http://tempuri.org/Infraestrutura/transicao/relacionar/atendimento/transformation/RetornoDSLIdentificarContratosProtocoloXQuery/";
...
declare namespace ns2 = "ld:br/com/netservicos/atendimento/webservice/IdentificarContratosJWS.ws";

declare function xf:RetornoDSLIdentificarContratosProtocoloXQuery($identificarContratoPorProtocoloResponse1 as element(ns2:identificarContratoPorProtocoloResponse))
    as element(ns1:consultarContratosPorProtocoloResponse) {
        <ns1:consultarContratosPorProtocoloResponse>
            <ns0:contratos>
                {
                    for $c in $identificarContratoPorProtocoloResponse1/ns0:contratoAssinante
                    return
...
declare variable $identificarContratoPorProtocoloResponse1 as element(ns2:identificarContratoPorProtocoloResponse) external;

xf:RetornoDSLIdentificarContratosProtocoloXQuery($identificarContratoPorProtocoloResponse1)
