 ...
 * with Net Serviços.
 * 
 * $Id: NETCRMEventResources.java,v 1.1 2009/12/03 19:08:26 jucenali Exp $
 */
package br.com.netservicos.netcrmcore.event.resources;
 ...
 * @since 02/07/2007
 */
public class NETCRMEventResources {
	
	/**
	 * Mapping for the bundle
	 */
	public final static String BUNDLE_NAME = "br/com/netservicos/netcrmcore/event/resources/NETCRMEventResourcesMessages";
