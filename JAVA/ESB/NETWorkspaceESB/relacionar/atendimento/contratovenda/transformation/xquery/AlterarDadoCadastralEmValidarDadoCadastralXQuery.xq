...
(:: pragma bea:local-element-parameter parameter="$dadoCadastralTitular1" type="ns3:parametrosAlterarDadoCadastralTitular/dadoCadastralTitular" location="../../wsdl/proxyservice/ContratoVendaWSDLV2_0.wsdl" ::)
...
declare namespace xf = "http://tempuri.org/relacionar/atendimento/contratovenda/transformation/xquery/AlterarDadoCadastralEmValidarDadoCadastralXQuery/";
...
declare function xf:AlterarDadoCadastralEmValidarDadoCadastralXQuery($consultarClientePorContratoResponse1 as element(ns6:consultarClientePorContratoResponse),
    $identificacaoContratoResponse1 as element(ns1:IdentificacaoContratoResponse),
...
xf:AlterarDadoCadastralEmValidarDadoCadastralXQuery($consultarClientePorContratoResponse1,
