(:: pragma bea:global-element-parameter parameter="$consultarClientesPorCPFResponse1" element="ns8:consultarClientesPorCPFResponse" location="../../wsdl/business/ClienteProspectDSLBSWSDLV1_0.wsdl" ::)
...
declare namespace xf = "http://tempuri.org/relacionar/atendimento/clienteprospect/transformation/xquery/ConsultarClientesPorCPFResponseXQuery/";
...
declare function xf:ConsultarClientesPorCPFResponseXQuery($consultarClientesPorCPFResponse1 as element(ns8:consultarClientesPorCPFResponse))
    as element(ns11:resultadoListarClientes) {
        <ns11:resultadoListarClientes>
            {
                let $ClientesProspect := $consultarClientesPorCPFResponse1/ns17:ClientesProspect
                return
...
declare variable $consultarClientesPorCPFResponse1 as element(ns8:consultarClientesPorCPFResponse) external;

xf:ConsultarClientesPorCPFResponseXQuery($consultarClientesPorCPFResponse1)
