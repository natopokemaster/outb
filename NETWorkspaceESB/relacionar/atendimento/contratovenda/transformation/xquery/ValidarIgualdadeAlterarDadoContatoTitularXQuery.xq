...
(:: pragma bea:local-element-parameter parameter="$dadoContatoTitular2" type="ns0:parametrosAlterarDadoContatoTitular/dadoContatoTitular" location="../../wsdl/proxyservice/ContratoVendaWSDLV2_0.wsdl" ::)

declare namespace xf = "http://tempuri.org/relacionar/atendimento/contratovenda/transformation/xquery/ValidarIgualdadeAlterarDadoContatoTitularXQuery/";
declare namespace ns0 = "http://www.netservicos.com.br/ContratoVendaV2/";

declare function xf:ValidarIgualdadeAlterarDadoContatoTitularXQuery($dadoContatoTitular1 as element(),
...
xf:ValidarIgualdadeAlterarDadoContatoTitularXQuery($dadoContatoTitular1,
    $dadoContatoTitular2)
