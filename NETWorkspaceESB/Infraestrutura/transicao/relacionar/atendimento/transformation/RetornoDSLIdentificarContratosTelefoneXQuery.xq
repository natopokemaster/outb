(:: pragma bea:global-element-parameter parameter="$identificarContratosPorTelefoneResponse1" element="ns1:identificarContratosPorTelefoneResponse" location="../wsdl/business/IdentificarContratosDSL.wsdl" ::)
(:: pragma bea:global-element-return element="ns0:contratos" location="../schema/ContratoAssinante.xsd" ::)

declare namespace xf = "http://tempuri.org/Infraestrutura/transicao/relacionar/atendimento/transformation/RetornoDSLIdentificarContratosTelefoneXQuery/";
...
declare function xf:RetornoDSLIdentificarContratosTelefoneXQuery($identificarContratosPorTelefoneResponse1 as element(ns1:identificarContratosPorTelefoneResponse))
    as element(ns0:contratos) {
        <ns0:contratos>
            {
                for $c in $identificarContratosPorTelefoneResponse1/ns0:contratoAssinante
                return
...
declare variable $identificarContratosPorTelefoneResponse1 as element(ns1:identificarContratosPorTelefoneResponse) external;

xf:RetornoDSLIdentificarContratosTelefoneXQuery($identificarContratosPorTelefoneResponse1)
