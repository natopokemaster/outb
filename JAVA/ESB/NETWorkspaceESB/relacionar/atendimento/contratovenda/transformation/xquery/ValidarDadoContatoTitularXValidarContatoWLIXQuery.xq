...
(:: pragma bea:local-element-parameter parameter="$dadoContatoTitular1" type="ns4:parametrosValidarDadoContatoTitular/dadoContatoTitular" location="../../wsdl/proxyservice/ContratoVendaWSDLV2_0.wsdl" ::)
...
declare namespace xf = "http://tempuri.org/relacionar/atendimento/contratovenda/transformation/xquery/ValidarDadoContatoTitularXValidarContatoWLIXQuery/";
...
declare function xf:ValidarDadoContatoTitularXValidarContatoWLIXQuery($identificacaoContratoResponse1 as element(ns2:IdentificacaoContratoResponse),
...
xf:ValidarDadoContatoTitularXValidarContatoWLIXQuery($identificacaoContratoResponse1,
    $dadoContatoTitular1)
