 ...
 * with Net Serviços.
 * 
 * $Id: NETCRMProspectBusinessResourceException.java,v 1.1 2009/12/03 19:10:15 jucenali Exp $
 */
package br.com.netservicos.netcrmcore.prospect.exceptions;
 ...
 * @since 29/06/2007
 */
public class NETCRMProspectBusinessResourceException extends BaseBusinessResourcesException {
	 ...
	 * @since 29/06/2007
	 */
	public NETCRMProspectBusinessResourceException() {
		super(BUNDLE_NAME);
	}
	 ...
	 * @param errorTrace
	 */
	public NETCRMProspectBusinessResourceException(String errorTrace) {
	 ...
	 * @param errorKeys
	 */
	public NETCRMProspectBusinessResourceException(Collection<String> errorKeys) {
	 ...
	 * @param errorTrace
	 */
	public NETCRMProspectBusinessResourceException(Throwable cause, String errorTrace) {
	 ...
	 * @param cause
	 */
	public NETCRMProspectBusinessResourceException(String errorKey, Throwable cause) {
	 ...
	 * @param cause
	 */
	public NETCRMProspectBusinessResourceException(String errorKey,
