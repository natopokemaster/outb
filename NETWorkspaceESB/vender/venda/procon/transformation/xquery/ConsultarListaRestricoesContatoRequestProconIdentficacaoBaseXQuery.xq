(:: pragma bea:global-element-parameter parameter="$parametrosConsultarTelefoneLeiNaoPerturbe1" element="ns1:parametrosConsultarTelefoneLeiNaoPerturbe" location="../../wsdl/proxyservice/ProconWSDLV2_0.wsdl" ::)
