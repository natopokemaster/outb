...
declare namespace xf = "http://tempuri.org/relacionar/atendimento/contratovenda/transformation/xquery/AlterarDadoContatoTitularXInsereRegistroQueueXQuery/";
declare namespace ns0 = "http://www.netservicos.com.br/AuditoriaQueue";

declare function xf:AlterarDadoContatoTitularXInsereRegistroQueueXQuery($nota as xs:string,
...
xf:AlterarDadoContatoTitularXInsereRegistroQueueXQuery($nota,
    $idRegistro,
    $campo,
    $cidade,
    $idAcao,
