(:: pragma bea:global-element-parameter parameter="$consultarClientesPorCNPJResponse1" element="ns8:consultarClientesPorCNPJResponse" location="../../wsdl/business/ClienteProspectDSLBSWSDLV1_0.wsdl" ::)
...
declare namespace xf = "http://tempuri.org/relacionar/atendimento/clienteprospect/transformation/xquery/ConsultarClientesPorCNPJResponseXQuery/";
...
declare function xf:ConsultarClientesPorCNPJResponseXQuery($consultarClientesPorCNPJResponse1 as element(ns8:consultarClientesPorCNPJResponse))
    as element(ns11:resultadoListarClientes) {
        <ns11:resultadoListarClientes>
            {
                let $ClientesProspect := $consultarClientesPorCNPJResponse1/ns17:ClientesProspect
                return
...
declare variable $consultarClientesPorCNPJResponse1 as element(ns8:consultarClientesPorCNPJResponse) external;

xf:ConsultarClientesPorCNPJResponseXQuery($consultarClientesPorCNPJResponse1)
