 ...
 */
@Service
public interface SnEscolaridadeService {
    SnEscolaridadeDTO findEscolaridade(SnAssinanteDTO snAssinanteDTO) throws UnprocessableEntityException, NotFoundException;
}
