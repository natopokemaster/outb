...
declare namespace xf = "http://tempuri.org/relacionar/atendimento/contratovenda/transformation/xquery/AlterarDadoContatoTitularBaseXCamposNulosXQuery/";
...
declare function xf:AlterarDadoContatoTitularBaseXCamposNulosXQuery($consultarClientePorContratoResponse1 as element(ns2:consultarClientePorContratoResponse))
    as element() {
        <dadoContatoTitular>
            <telefones>
                {
...
xf:AlterarDadoContatoTitularBaseXCamposNulosXQuery($consultarClientePorContratoResponse1)
