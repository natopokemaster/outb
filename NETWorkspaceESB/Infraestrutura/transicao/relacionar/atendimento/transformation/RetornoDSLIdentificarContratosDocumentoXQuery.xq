(:: pragma bea:global-element-parameter parameter="$identificarContratosPorDocumentoResponse1" element="ns1:identificarContratosPorDocumentoResponse" location="../wsdl/business/IdentificarContratosDSL.wsdl" ::)
(:: pragma bea:global-element-return element="ns0:contratos" location="../schema/ContratoAssinante.xsd" ::)

declare namespace xf = "http://tempuri.org/Infraestrutura/transicao/relacionar/atendimento/transformation/RetornoDSLIdentificarContratosDocumentoXQuery/";
...
declare function xf:RetornoDSLIdentificarContratosDocumentoXQuery($identificarContratosPorDocumentoResponse1 as element(ns1:identificarContratosPorDocumentoResponse))
    as element(ns0:contratos) {
        <ns0:contratos>
            {
                for $c in $identificarContratosPorDocumentoResponse1/ns0:contratoAssinante
                return
...
declare variable $identificarContratosPorDocumentoResponse1 as element(ns1:identificarContratosPorDocumentoResponse) external;

xf:RetornoDSLIdentificarContratosDocumentoXQuery($identificarContratosPorDocumentoResponse1)
