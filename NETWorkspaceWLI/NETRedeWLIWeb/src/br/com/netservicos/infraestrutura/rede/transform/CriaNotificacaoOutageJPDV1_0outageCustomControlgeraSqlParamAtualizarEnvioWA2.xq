...
(:: pragma bea:java-type-return type="br.com.netservicos.infraestrutura.rede.transform.CriaNotificacaoOutageJPDV1_0Transformation.outageCustomControlgeraSqlParamAtualizarEnvioWA2Object" ::)

declare namespace xf = "http://tempuri.org/NETRedeWLIWeb/src/br/com/netservicos/infraestrutura/rede/transform/CriaNotificacaoOutageJPDV1_0outageCustomControlgeraSqlParamAtualizarEnvioWA2/";
declare namespace ns-1 = "http://www.netservicos.com.br/rede/outage";

declare function xf:CriaNotificacaoOutageJPDV1_0outageCustomControlgeraSqlParamAtualizarEnvioWA2($dsErro as xs:string,
    $fcEnvio as xs:string,
    $parametros as element(ns-1:ParametrosNotificarOutage),
    $tpEvento as xs:string)
    as element() {
        <outageCustomControlgeraSqlParamAtualizarEnvioWA2Object>
...
xf:CriaNotificacaoOutageJPDV1_0outageCustomControlgeraSqlParamAtualizarEnvioWA2($dsErro,
    $fcEnvio,
    $parametros,
    $tpEvento)
