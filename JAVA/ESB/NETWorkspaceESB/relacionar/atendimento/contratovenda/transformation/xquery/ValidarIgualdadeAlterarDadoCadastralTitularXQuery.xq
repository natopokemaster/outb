...
(:: pragma bea:local-element-parameter parameter="$dadoCadastralTitular2" type="ns0:parametrosAlterarDadoCadastralTitular/dadoCadastralTitular" location="../../wsdl/proxyservice/ContratoVendaWSDLV2_0.wsdl" ::)

declare namespace xf = "http://tempuri.org/relacionar/atendimento/contratovenda/transformation/xquery/ValidarIgualdadeAlterarDadoCadastralTitularXQuery/";
declare namespace ns0 = "http://www.netservicos.com.br/ContratoVendaV2/";

declare function xf:ValidarIgualdadeAlterarDadoCadastralTitularXQuery($dadoCadastralTitular1 as element(),
...
xf:ValidarIgualdadeAlterarDadoCadastralTitularXQuery($dadoCadastralTitular1,
