...
declare namespace xf = "http://tempuri.org/relacionar/atendimento/contratovenda/transformation/xquery/ClienteProspectXAlterarDadoCadastralTitularXQuery/";
...
declare function xf:ClienteProspectXAlterarDadoCadastralTitularXQuery($consultarClientePorContratoResponse1 as element(ns2:consultarClientePorContratoResponse))
    as element() {
...
xf:ClienteProspectXAlterarDadoCadastralTitularXQuery($consultarClientePorContratoResponse1)
